    ...
    <div class="w-screen h-[800px] flex justify-around items-center bg-[#343434]">
        <div class="border w-[400px] h-[400px] flex flex-col justify-center items-center bg-white rounded-lg">
            <form action="/api/create" method="POST" class="flex flex-col justify-around items-center h-full py-6">
                <label for="newTask" class=" font-semibold text-xl">INGRESE NUEVA TAREA</label>
                <textarea class="border p-2 border-black w-[300px] h-[200px] my-4 rounded-lg" type="text" id="newTask"
                    name="newTask"></textarea>
                <div class="flex justify-between  w-full">
                    <button
                        class="bg-[#7fffd4] hover:bg-[#39b089] py-2 px-4 rounded-lg text-[#2e9d71] hover:text-[#46f2ad] shadow-md hover:shadow-lg shadow-[#3a705e81] hover:shadow-[#85ffd6a7]"
                        type="submit"> Crear
                        tarea</button>
                    <button
        ...
        <div class=" bg-[url('/public/sheet.png')] bg-cover w-[500px] h-[650px] px-16 pt-[73px]">
            <table class="w-full">
                <thead>
                    <tr>
                        <th colspan="4"> Tablero de Tareas Pendientes</th>
                    </tr>
                </thead>
                <tbody class="">
                    @foreach ($tasks as $task)
                        <tr class="flex justify-around w-full">
                            <form action="/api/update/{{ $task->id }}" method="POST">
                                <td>
                                    <button type="submit"
                                        class="bg-[#4df68b] hover:bg-[#2d8a3c]  rounded-full text-[#1e5f3b] hover:text-[#64ed64] shadow-md hover:shadow-lg shadow-[#1e5f2a81] hover:shadow-[#89f197ce]">
